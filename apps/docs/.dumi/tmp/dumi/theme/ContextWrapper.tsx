...
const themeConfig = {"footer":"Copyright © 2024 base UI Team | Powered by Dumi","prefersColor":{"default":"light","switch":true},"nprogress":true,"lastUpdated":true,"name":"base UI","nav":[{"title":"Guide","link":"/guide"},{"title":"Button","link":"/components/button"},{"title":"Input","link":"/components/input"}],"socialLinks":{"github":"https://github.com/your-org/base-ui"}};
